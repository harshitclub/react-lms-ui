  ...
  return (
    <>
      <AdminDashboardLayout>
        <section className="adminCourses p-3 ">
          <div className="adminCoursesHeading">
            <h1 className="text-3xl font-semibold">Courses</h1>
            <p className="mb-3 text-muted-foreground">
              A list of all the courses of LMS.
            </p>
          </div>
          <div className="adminCoursesHeader grid grid-cols-4 gap-3 border-b mb-3">
            <Input placeholder="Search course..." className="col-span-2" />
            <Select>
              <SelectTrigger className="w-full mb-3 col-span-1">
                <SelectValue placeholder="Select by creator" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="Campussutras Private Limited">
          ...
          <div className="adminCoursesContainer grid grid-cols-4 gap-3">
            {courses.map((course) => (
              <CourseCard
