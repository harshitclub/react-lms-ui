  ...
  return (
    <>
      <form>
        <Card className="rounded-sm mb-5 shadow-sm">
          <CardContent className="p-5">
            <div className="flex justify-between gap-3 mb-5">
              <div className="w-1/2">
                <h3 className="text-md  mb-1">Individual Name</h3>
        ...
        <Button className="mb-2">Update Individual</Button>
      </form>
    </>
  );
}

export default AdminIndividualForm;
